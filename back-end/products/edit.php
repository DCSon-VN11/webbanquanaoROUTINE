...
if (isset($_POST['btnLuu'])) {
    ...
    //Câu Lệnh SQL UPDATE 
    $sql = "UPDATE products set cate_id='$cate_id', pro_name='$pro_name', pro_image='$pro_image',pro_price='$pro_price', pro_sale='$pro_sale', pro_intro='$pro_intro' WHERE pro_id = $pro_id";
    //echo $sql; die;
